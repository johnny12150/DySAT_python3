...
if FLAGS.featureless:
    adjs = list(adjs)  # for python 3, transfer map to list
...
# np.save(SAVE_DIR + '/{}_embs_{}_{}.npy'.format(FLAGS.model, FLAGS.dataset, FLAGS.time_steps - 2), emb)
